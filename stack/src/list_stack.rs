...
mod tests {
    ...
    #[test]
    fn test_stack_size() {
        assert_eq!(size_of::<ListStack<i32>>(), 24);
    }
    ...
    fn test_iter() {
        ...
        let mut stack = ListStack::from_iter(numbers);
    ...
    fn test_eq() {
        let numbers = [1, 1, 2, 3, 5, 8];
        let stack1 = ListStack::from_iter(numbers);
        let stack2 = ListStack::from_iter(numbers);
