...
12. [报文响应时间 - 字符串](response-time-of-message/index.md)
13. [连续字母长度 - 字符串](length-of-continous-letters/index.md)
14. [最长连续子序列 - 滑动窗口](longest-consecutive-sequence/index.md)
15. [计算面积/绘图机器](drawing-machine/index.md)
16. [计算三叉搜索树的高度 - 树](height-of-ternary-tree/index.md)
17. [单词接龙](word-chain/index.md)
18. [喊7的次数重排](say-7/index.md)
19. [VLAN资源池](vlan/index.md)
