...
- [297.序列化二叉树](https://leetcode.com/problems/serialize-and-deserialize-binary-tree)
- [LCR 124. 推理二叉树, 重建二叉树](https://leetcode.cn/problems/zhong-jian-er-cha-shu-lcof/)
- [LCR 143. 树的子结构判断](https://leetcode.cn/problems/shu-de-zi-jie-gou-lcof/)
...
- [LRC 174.二叉搜索树的第k大节点](https://leetcode.cn/problems/er-cha-sou-suo-shu-de-di-kda-jie-dian-lcof/)
- [面试题33.二叉搜索树的后序遍历序列](https://leetcode.cn/problems/er-cha-sou-suo-shu-de-hou-xu-bian-li-xu-lie-lcof/)