...
mod tests {
    ...
    fn test_rms_speed_of_molecule() {
        assert!((rms_speed_of_molecule(100.0, 2.0) - 35.315_279_554_323_226).abs() < f64::EPSILON);
        assert!((rms_speed_of_molecule(273.0, 12.0) - 23.821_458_421_977_443).abs() < f64::EPSILON);
    }
}
