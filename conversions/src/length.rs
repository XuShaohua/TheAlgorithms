...
mod tests {
    ...
    fn test_length_conversion() {
        const PAIRS: &[(f64, Unit, Unit, f64)] = &[
            ...
            (3.0, Unit::Kilometer, Unit::Mile, 1.864_113_000_000_000_1),
            (2.0, Unit::Foot, Unit::Meter, 0.6096),
            (4.0, Unit::Foot, Unit::Yard, 1.333_329_312),
            (1.0, Unit::Inch, Unit::Meter, 0.0254),
            (2.0, Unit::Inch, Unit::Mile, 3.156_564_68e-05),
            (2.0, Unit::Centimeter, Unit::Millimeter, 20.0),
            (2.0, Unit::Centimeter, Unit::Yard, 0.021_872_2),
            (4.0, Unit::Yard, Unit::Meter, 3.6576),
            (4.0, Unit::Yard, Unit::Kilometer, 0.003_657_6),
            (3.0, Unit::Foot, Unit::Meter, 0.914_400_000_000_000_1),
            (3.0, Unit::Foot, Unit::Inch, 36.000_019_44),
            (4.0, Unit::Mile, Unit::Kilometer, 6.437_36),
            (2.0, Unit::Mile, Unit::Inch, 126_719.753_468),
            (3.0, Unit::Millimeter, Unit::Centimeter, 0.3),
            (3.0, Unit::Millimeter, Unit::Inch, 0.118_110_3),
        ];
